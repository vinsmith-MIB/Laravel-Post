                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 100px; text-align:center">
                            <form action="{{ route('permissions.destroy', $permissions->id) }}" method="POST" class="d-inline delete-data">
                                <div class="btn-group">
                                    <a href="{{ route('permissions.edit', $permissions->id) }}" class="btn btn-warning">
