                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="seotitle" id="seotitle"
                                    value="{{ old('title', $posts->seotitle) }}" required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="form-group">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    @if ($category->id == $posts->category_id) selected @endif>{{ $category->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col col-12 col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <br>
                                    @if ($posts->image && Storage::exists('images/posts/' . $posts->image))
                                        <img src="{{ Storage::url('images/posts/' . $posts->image) }}"
                            ...
                            <div class="col col-12 col-lg-4">
                                <div class="form-group mb-3">
                                    <label for="image">New Featured Image</label>
                                    <br>
