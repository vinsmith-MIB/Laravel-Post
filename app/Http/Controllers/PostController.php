...
class PostController extends Controller
{
    ...
    public function index()
    {
        $data = [
            ...
            'sidebar_recent_posts'  => Post::where('is_publish', 'publish')->orderBy('created_at', 'desc')->limit(3)->get(),
            'latest_posts'          => Post::where('is_publish', 'publish')->orderBy('id', 'desc')->paginate(6),
    ...
    public function archive($year, $month)
    {
        ...
        $data = [
            ...
            'seo_title'            => 'Post Archive: ' . date('F Y', mktime(0, 0, 0, $month, 1, $year)),
            'categories'            => $this->categories,
    ...
    public function category($category)
    {
        ...
        $data = [
            'page_title'            => 'Post: Category - ' . $category->title,
            'seo_title'            => 'Post: Category - ' . $category->title,
            'categories'            => $this->categories,
    ...
    public function search(Request $request)
    {
        $data = [
            ...
            'seo_title'            => 'Search Result: ' . request()->keywords,
